...
本机完整版位于 `E:/毕设知识库/simulation_reproduction/comparison/论文与仿真逐项对比分析.html`，可离线阅读18张图和9张表。原论文页图及包含这些页图的HTML仅保存在本机，GitHub阅读版在相应位置标注本地附件名。
...
```powershell
Set-Location 'E:\毕设知识库\simulation_reproduction\comparison'
