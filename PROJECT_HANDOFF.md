...
- 局部子模型收敛证据（满0.5 ms）：h0=0.25/0.125/0.08/0.05 mm对应力32.40/31.98/31.86/31.94 N（**1.7%无趋势波动**），挠度311.0/310.0 µm，残余压入2.13/1.26/0.85/0.53 µm单调下降，能量漂移1.2e-4～1.3e-5。时间步safety 0.5→0.25一致到1%。
